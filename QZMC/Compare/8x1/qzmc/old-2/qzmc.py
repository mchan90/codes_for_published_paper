...
for isec in range(nsec):
    ...
    eigen_v               = np.zeros((n_eig,n_eig),dtype=complex)
...
def ExactEvolution (isec, alpha, eps, time):
    ...
    vec = np.zeros(n_eig,dtype=complex)
...
beta_list = np.linspace(0.1,6.1,num=61)
#beta_list = [2.0]
