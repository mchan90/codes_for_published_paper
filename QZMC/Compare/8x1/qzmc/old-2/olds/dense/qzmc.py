...
#    comm.Barrier()
#    start_time = datetime.now()
#    comm.Bcast([eigen_energies_exact[0],MPI.DOUBLE],root=0)
#    comm.Bcast([eigen_vectors_exact[0],MPI.DOUBLE_COMPLEX],root=0)
#    end_time = datetime.now()
#    elapsed = end_time-start_time
#    elapsed = elapsed.total_seconds()
#    if (core==0):
#        st = '# Bcast finished, elapsed time = {elapsed} secs'.format(elapsed=elapsed)
#        memory_usage(st)
