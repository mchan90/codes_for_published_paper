...
#beta_list = np.arange(0.1, 4.1, 0.1)
#beta_list = [2.0]
...
for isec in range(nsec):
    ...
    eigen_e = H_sub.diagonal() # coulomb interaction matrix is diagonal in occupation number basis
