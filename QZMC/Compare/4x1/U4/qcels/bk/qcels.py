...
isec = 0
eta = np.abs(phi_start.conj().T@eigen_vectors_exact[isec][-1,:,0])**2
populations = np.zeros(dim_sub[isec])
for k in range(dim_sub[isec]):
...
#time_max_list = [10*j for j in range(1,120)]
#time_max_list = [10, 25, 50, 100, 150, 300, 500, 1000, 2000, 4000, 8000]
#time_max_list = [10, 35, 60, 210, 360, 620, 1240, 2480, 4960, 9920]
time_max_list = [25, 50, 100, 200, 500, 1000, 2000, 4000, 8000]
