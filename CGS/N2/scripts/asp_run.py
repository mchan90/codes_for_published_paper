...
with open(material_home + '/on_the_fly/optimal_schedule','r') as file_:
    ...
    for line in lines:
        ls = line.split()
        taus_cgs.append(float(ls[0]))
        ss_cgs.append(float(ls[1]))




t_f_max = 836129.2253548327
dt = 0.5
num_tf = 32
...
for t_f in my_tasks:
    ...
    ov2 = adiabatic_evolve_krylov(taus_cgs, ss_cgs, t_f, dt, phi, fcivec_exact, info_i, info_f, m_krylov)
