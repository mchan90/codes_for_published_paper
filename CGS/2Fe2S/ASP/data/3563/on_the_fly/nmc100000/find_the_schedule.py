...
fcivec_00      = np.load(indx_home + "/fcivec_0.npy")[0]
fcivec_exact_0 = np.load(material_home + "FCI/output/fcivec_FULL.npy")[0]  
...
def compute_fj (alpha, hj, phi_asp):
    ...
    x_max = eigen_ej[0]+1.0/(sqrt2*beta)+np.pi/(2.1*omega_max)
...
def compute_pj (alpha, hj, h1, ej, phi_asp):
    ...
    x_max = eigen_e1[0]+1.0/(sqrt2*beta)+np.pi/(2.1*omega_max)
...
gap_ref = 3.3059591862183879e-02 # at indx=0
t1_ref  = 7 # at indx=0

gap     = 0.00047005818123579957
