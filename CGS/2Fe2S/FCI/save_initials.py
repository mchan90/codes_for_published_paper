...
ecore, h1e, g2e, norb, nelec, ms = loadERIs('../DFT/output/FCIDUMP_FULL')
...
np.save("./output/E_FULL.npy", e+ecore)
np.save("./output/fcivec_FULL.npy", ci)
...
import h5py
f = h5py.File('../DFT/output/hs_bp86.chk', 'r')
